        ...
        <div class="row row-video">
            <?php foreach($video as $k=>$v) { ?>
                <div class="col-6 col-md-3 col-sm-4 mb-3 mg-video">
                    <div class="video">
                        <p class="pic-video">
                            <a class="scale-img text-decoration-none" data-fancybox="video" data-src="<?=$v['link_video']?>" title="<?=$v['name'.$lang]?>">
                        ...
                        <h3>
                            <a class="name-video text-split scale-img text-decoration-none" data-fancybox="video" data-src="<?=$v['link_video']?>" title="<?=$v['name'.$lang]?>"><?=$v['name'.$lang]?></a>
                        </h3>
                    </div>
                </div>
            <?php } ?>
