<div class="login-view-website text-sm"><a href="../" target="_blank" title="Trang chủ"><i class="fas fa-reply mr-2"></i>Trang chủ</a></div>
<div class="login-box">
    <div class="card">
...
<div class="login-copyright text-sm">Powered by thanhphat</a></div>