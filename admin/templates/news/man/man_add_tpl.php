                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <?php foreach($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if(isset($config['news'][$type]['office']) && $config['news'][$type]['office'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="office<?=$k?>">Chức vụ (<?=$k?>):</label>
                                                    <input type="text" class="form-control text-sm" name="data[office<?=$k?>]" id="office<?=$k?>" placeholder="Chức vụ (<?=$k?>)" value="<?=(!empty($flash->has('office'.$k))) ? $flash->get('office'.$k) : @$item['office'.$k]?>">
                                                </div>
                                            <?php } ?>
